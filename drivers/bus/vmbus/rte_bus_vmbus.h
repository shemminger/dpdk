 ...
 */
int __rte_experimental rte_vmbus_chan_open(struct rte_vmbus_device *device,
...
rte_vmbus_max_channels(const struct rte_vmbus_device *device);
 ...
 *	Pointer to vmbus_channel structure.
 */
void __rte_experimental rte_vmbus_chan_dump(FILE *f, const struct vmbus_channel *chan);
